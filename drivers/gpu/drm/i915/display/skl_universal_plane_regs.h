...
#define   PLANE_CTL_SMOOTH_SYNC_ENABLE		REG_BIT(18)
...
#define   PLANE_COLOR_SS_DITHER_STEP_SIZE_MASK		REG_GENMASK(2, 0)
#define   PLANE_COLOR_SS_STEP_SIZE_1			REG_FIELD_PREP(PLANE_COLOR_SS_DITHER_STEP_SIZE_MASK, 0)
#define   PLANE_COLOR_SS_STEP_SIZE_2			REG_FIELD_PREP(PLANE_COLOR_SS_DITHER_STEP_SIZE_MASK, 1)
#define   PLANE_COLOR_SS_STEP_SIZE_4			REG_FIELD_PREP(PLANE_COLOR_SS_DITHER_STEP_SIZE_MASK, 2)
#define   PLANE_COLOR_SS_STEP_SIZE_8			REG_FIELD_PREP(PLANE_COLOR_SS_DITHER_STEP_SIZE_MASK, 3)
#define   PLANE_COLOR_SS_STEP_SIZE_16			REG_FIELD_PREP(PLANE_COLOR_SS_DITHER_STEP_SIZE_MASK, 4)
